...
static void mavlink_test_rotor_speed(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ROTOR_SPEED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_rotor_speed_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0
    };
    mavlink_rotor_speed_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.w_0 = packet_in.w_0;
        packet1.w_1 = packet_in.w_1;
        packet1.w_2 = packet_in.w_2;
        packet1.w_3 = packet_in.w_3;
        packet1.tau_x = packet_in.tau_x;
        packet1.tau_y = packet_in.tau_y;
        packet1.tau_z = packet_in.tau_z;
        packet1.thrust = packet_in.thrust;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ROTOR_SPEED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ROTOR_SPEED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rotor_speed_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_rotor_speed_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rotor_speed_pack(system_id, component_id, &msg , packet1.w_0 , packet1.w_1 , packet1.w_2 , packet1.w_3 , packet1.tau_x , packet1.tau_y , packet1.tau_z , packet1.thrust );
    mavlink_msg_rotor_speed_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rotor_speed_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.w_0 , packet1.w_1 , packet1.w_2 , packet1.w_3 , packet1.tau_x , packet1.tau_y , packet1.tau_z , packet1.thrust );
    mavlink_msg_rotor_speed_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_rotor_speed_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rotor_speed_send(MAVLINK_COMM_1 , packet1.w_0 , packet1.w_1 , packet1.w_2 , packet1.w_3 , packet1.tau_x , packet1.tau_y , packet1.tau_z , packet1.thrust );
    mavlink_msg_rotor_speed_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ROTOR_SPEED") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ROTOR_SPEED) != NULL);
#endif
}

static void mavlink_test_resilient_state_estimate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RESILIENT_STATE_ESTIMATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_resilient_state_estimate_t packet_in = {
        963497464,{ 45.0, 46.0, 47.0, 48.0 },{ 157.0, 158.0, 159.0 },241.0,{ 269.0, 270.0, 271.0 },{ 353.0, 354.0, 355.0 },{ 437.0, 438.0, 439.0 },{ 521.0, 522.0, 523.0 },{ 605.0, 606.0, 607.0, 608.0 },{ 717.0, 718.0, 719.0 },801.0,{ 829.0, 830.0, 831.0, 832.0 },{ 941.0, 942.0, 943.0 },1025.0,1053.0,{ 1081.0, 1082.0, 1083.0 },{ 1165.0, 1166.0, 1167.0 },21,88
    };
    mavlink_resilient_state_estimate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.thrust_ground_truth = packet_in.thrust_ground_truth;
        packet1.thrust_estimate = packet_in.thrust_estimate;
        packet1.anomaly_score = packet_in.anomaly_score;
        packet1.anomaly_detection_rate = packet_in.anomaly_detection_rate;
        packet1.anomaly_flag = packet_in.anomaly_flag;
        packet1.attack_flag = packet_in.attack_flag;
        
        mav_array_memcpy(packet1.rotor_speed, packet_in.rotor_speed, sizeof(float)*4);
        mav_array_memcpy(packet1.torque_ground_truth, packet_in.torque_ground_truth, sizeof(float)*3);
        mav_array_memcpy(packet1.raw_angular_vel, packet_in.raw_angular_vel, sizeof(float)*3);
        mav_array_memcpy(packet1.raw_acc, packet_in.raw_acc, sizeof(float)*3);
        mav_array_memcpy(packet1.imu_angular_vel, packet_in.imu_angular_vel, sizeof(float)*3);
        mav_array_memcpy(packet1.imu_acc, packet_in.imu_acc, sizeof(float)*3);
        mav_array_memcpy(packet1.attitude_standard, packet_in.attitude_standard, sizeof(float)*4);
        mav_array_memcpy(packet1.torque_estimate, packet_in.torque_estimate, sizeof(float)*3);
        mav_array_memcpy(packet1.attitude_estimate, packet_in.attitude_estimate, sizeof(float)*4);
        mav_array_memcpy(packet1.angular_vel_estimate, packet_in.angular_vel_estimate, sizeof(float)*3);
        mav_array_memcpy(packet1.imu_acc_offset, packet_in.imu_acc_offset, sizeof(float)*3);
        mav_array_memcpy(packet1.imu_gyro_offset, packet_in.imu_gyro_offset, sizeof(float)*3);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RESILIENT_STATE_ESTIMATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RESILIENT_STATE_ESTIMATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_resilient_state_estimate_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_resilient_state_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_resilient_state_estimate_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.rotor_speed , packet1.torque_ground_truth , packet1.thrust_ground_truth , packet1.raw_angular_vel , packet1.raw_acc , packet1.imu_angular_vel , packet1.imu_acc , packet1.attitude_standard , packet1.torque_estimate , packet1.thrust_estimate , packet1.attitude_estimate , packet1.angular_vel_estimate , packet1.anomaly_score , packet1.anomaly_detection_rate , packet1.anomaly_flag , packet1.imu_acc_offset , packet1.imu_gyro_offset , packet1.attack_flag );
    mavlink_msg_resilient_state_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_resilient_state_estimate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.rotor_speed , packet1.torque_ground_truth , packet1.thrust_ground_truth , packet1.raw_angular_vel , packet1.raw_acc , packet1.imu_angular_vel , packet1.imu_acc , packet1.attitude_standard , packet1.torque_estimate , packet1.thrust_estimate , packet1.attitude_estimate , packet1.angular_vel_estimate , packet1.anomaly_score , packet1.anomaly_detection_rate , packet1.anomaly_flag , packet1.imu_acc_offset , packet1.imu_gyro_offset , packet1.attack_flag );
    mavlink_msg_resilient_state_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_resilient_state_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_resilient_state_estimate_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.rotor_speed , packet1.torque_ground_truth , packet1.thrust_ground_truth , packet1.raw_angular_vel , packet1.raw_acc , packet1.imu_angular_vel , packet1.imu_acc , packet1.attitude_standard , packet1.torque_estimate , packet1.thrust_estimate , packet1.attitude_estimate , packet1.angular_vel_estimate , packet1.anomaly_score , packet1.anomaly_detection_rate , packet1.anomaly_flag , packet1.imu_acc_offset , packet1.imu_gyro_offset , packet1.attack_flag );
    mavlink_msg_resilient_state_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("RESILIENT_STATE_ESTIMATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_RESILIENT_STATE_ESTIMATE) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_rotor_speed(system_id, component_id, last_msg);
    mavlink_test_resilient_state_estimate(system_id, component_id, last_msg);
