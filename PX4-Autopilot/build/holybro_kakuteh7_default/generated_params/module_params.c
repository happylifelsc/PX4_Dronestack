...
/**
 * Output Protocol Configuration for PWM Main 1-2
 *
 * Select which Output Protocol to use for outputs PWM Main 1-2.
 * 
...
/**
 * Output Protocol Configuration for PWM Main 3-4
 *
 * Select which Output Protocol to use for outputs PWM Main 3-4.
 * 
 * Custom PWM rates can be used by directly setting any value >0.
 * 
 *
...
/**
 * Output Protocol Configuration for PWM Main 7-8
 *
 * Select which Output Protocol to use for outputs PWM Main 7-8.
 * 
 * Custom PWM rates can be used by directly setting any value >0.
 * 
 *
 ...
 * @reboot_required True
 */
PARAM_DEFINE_INT32(PWM_MAIN_TIM3, 400);
...
/**
 * PWM Main 7 Output Function
 *
 * Select what should be output on PWM Main 7.
 * 
 * The default failsafe value is set according to the selected function:
 * - 'Min' for ConstantMin
 * - 'Max' for ConstantMax
...
/**
 * PWM Main 8 Output Function
 *
 * Select what should be output on PWM Main 8.
 * 
 * The default failsafe value is set according to the selected function:
 * - 'Min' for ConstantMin
 * - 'Max' for ConstantMax
